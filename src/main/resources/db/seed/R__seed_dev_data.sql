...
--    데모 중심 근처(서울, 37.61 / 126.998) 반경 안에 mailbox 를 둔다.
...
INSERT INTO app_users (id, nickname, access_status, app_role, mailbox_lat, mailbox_lng, mailbox_enabled_at, created_at, updated_at) VALUES
    ('00000000-0000-0000-0000-0000000000a1', '민들레',   'ACTIVE', 'USER',     37.6110, 126.9975, TIMESTAMPTZ '2026-09-10 09:00:00+09', TIMESTAMPTZ '2026-09-10 09:00:00+09', TIMESTAMPTZ '2026-09-10 09:00:00+09'),
    ('00000000-0000-0000-0000-0000000000a2', '바람개비', 'ACTIVE', 'USER',     37.6125, 126.9990, TIMESTAMPTZ '2026-09-11 09:00:00+09', TIMESTAMPTZ '2026-09-11 09:00:00+09', TIMESTAMPTZ '2026-09-11 09:00:00+09'),
    ('00000000-0000-0000-0000-0000000000a3', '자갈길',   'ACTIVE', 'OPERATOR', 37.6098, 126.9960, TIMESTAMPTZ '2026-09-11 09:00:00+09', TIMESTAMPTZ '2026-09-11 09:00:00+09', TIMESTAMPTZ '2026-09-11 09:00:00+09'),
...
-- ---------------------------------------------------------------------------
-- 4) 장소 (places) — 데모 중심 반경 내 8곳(고정 UUID). label 은 선택.
-- ---------------------------------------------------------------------------
INSERT INTO places (id, label, lat, lng, created_at) VALUES
    ('00000000-0000-0000-0000-000000000010', '골목 안 조용한 카페',   37.6112, 126.9978, now()),
    ('00000000-0000-0000-0000-000000000011', '광장 앞 브런치',       37.6128, 126.9992, now()),
    ('00000000-0000-0000-0000-000000000012', '언덕 위 산책로',       37.6095, 126.9955, now()),
    ('00000000-0000-0000-0000-000000000013', '작은 서점 겸 북카페',  37.6103, 126.9969, now()),
    ('00000000-0000-0000-0000-000000000014', '심야 재즈 바',         37.6119, 126.9985, now()),
    ('00000000-0000-0000-0000-000000000015', '전시 공간',           37.6132, 126.9971, now()),
    ('00000000-0000-0000-0000-000000000016', '노트북 작업 카페',     37.6107, 126.9996, now()),
    ('00000000-0000-0000-0000-000000000017', NULL,                  37.6090, 126.9948, now());
...
INSERT INTO memories (
    ...
    ('00000000-0000-0000-0000-0000000000c1','00000000-0000-0000-0000-0000000000a3','00000000-0000-0000-0000-000000000010',
     ...
     '골목 안 조용한 카페',37.6112,126.9978, -1,-1,-1,-1, 'AI','AI','AI','USER',
    ...
    ('00000000-0000-0000-0000-0000000000c2','00000000-0000-0000-0000-0000000000a2','00000000-0000-0000-0000-000000000011',
     ...
     '광장 앞 브런치',37.6128,126.9992, 1,1,1,1, 'AI','AI','USER','AI',
     1,'SUCCEEDED','CLASSIFIED','mock-analysis','mock-v1', NULL,NULL,NULL,
    ...
    ('00000000-0000-0000-0000-0000000000c3','00000000-0000-0000-0000-0000000000a2','00000000-0000-0000-0000-000000000012',
     ...
     '언덕 위 산책로',37.6095,126.9955, -1,-1,-1,-1, 'USER','USER','USER','USER',
    ...
    ('00000000-0000-0000-0000-0000000000c4','00000000-0000-0000-0000-0000000000a3','00000000-0000-0000-0000-000000000013',
     ...
     '작은 서점 겸 북카페',37.6103,126.9969, 1,-1,-1,1, 'AI','USER','AI','AI',
    ...
    ('00000000-0000-0000-0000-0000000000c5','00000000-0000-0000-0000-0000000000a2','00000000-0000-0000-0000-000000000014',
     ...
     '심야 재즈 바',37.6119,126.9985, 1,1,1,1, 'AI','AI','AI','AI',
     1,'SUCCEEDED','CLASSIFIED','mock-analysis','mock-v1', NULL,NULL,NULL,
    ...
    ('00000000-0000-0000-0000-0000000000c6','00000000-0000-0000-0000-0000000000a3','00000000-0000-0000-0000-000000000015',
     ...
     '전시 공간',37.6132,126.9971, -1,1,-1,-1, 'USER','AI','USER','USER',
     1,'SUCCEEDED','CLASSIFIED','mock-analysis','mock-v1', NULL,NULL,NULL,
    ...
    ('00000000-0000-0000-0000-0000000000c7','00000000-0000-0000-0000-0000000000a2','00000000-0000-0000-0000-000000000016',
     ...
     '노트북 작업 카페',37.6107,126.9996, 1,1,-1,-1, 'AI','AI','AI','AI',
     1,'SUCCEEDED','CLASSIFIED','mock-analysis','mock-v1', NULL,NULL,NULL,
    ...
    ('00000000-0000-0000-0000-0000000000d1','00000000-0000-0000-0000-0000000000a1','00000000-0000-0000-0000-000000000017',
     ...
     NULL,37.6090,126.9948, -1,-1,-1,-1, 'USER','USER','USER','USER',
    ...
    ('00000000-0000-0000-0000-0000000000d2','00000000-0000-0000-0000-0000000000a2','00000000-0000-0000-0000-000000000010',
     ...
     '골목 안 조용한 카페',37.6112,126.9978, -1,-1,1,-1, 'USER','USER','USER','USER',
     1,'NOT_RUN','NOT_RUN',NULL,NULL, NULL,NULL,NULL,
...
--
--    s1: u1, 2026-09-16 DELIVERED (m1 을 받음 → letter_deliveries 로 연결)
--    s2: u2, 2026-09-17 NO_CANDIDATE (후보 없음)
--    s3: u1, 2026-09-17 DELIVERED (m3 을 받음)
...
INSERT INTO daily_selections (
    ...
    ('00000000-0000-0000-0000-0000000000a1', DATE '2026-09-17',
        ...
        1, 1, 4, 'SINGLE_TOP', TIMESTAMPTZ '2026-09-17 09:00:05+09', TIMESTAMPTZ '2026-09-17 09:00:00+09'),
